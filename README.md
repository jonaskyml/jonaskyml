...
### Skills
[![My Skills](https://skillicons.dev/icons?i=linux,debian,kali,arch,mint,windows,git,github,vscodium,vim,visualstudio,vscode,obsidian,unity,discord,ableton,gmail,stackoverflow,tailwind,html,cs,php,css,mysql,symfony,md,latex,npm)](https://skillicons.dev)
